...
export function createDiscordFrontend(
  ...
  return {
    ...
    async start() {
      ...
      // discord.js keeps the process alive via its websocket; we don't need
      // an explicit hold-open promise. Telegram's bot.start() blocks; here
      // we return after login and let event listeners take over.
    },
